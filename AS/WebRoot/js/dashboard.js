$(document).ready(function(){
	...
	*/
	...
	$('.draggableWindow').dblclick(function(){
		 $(this).children('.content:first').slideToggle();
	   });
	...
	//右边栏的js
	 $(".right_title").click(function(){
	    $(this).next(".right_content").slideToggle('fast');
	  });
	 //facebox
	 $('a[rel*=facebox]').facebox() ;
	 //fancybox
	// $('a#fancybox1').fancybox({
		//		'hideOnContentClick': false,'callbackOnShow':true,'callbackOnClose':false});
