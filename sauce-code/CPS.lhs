...
toCPSWithContext answerType t capGamma = 
  case t of
    ...
    S.Fix t1        -> case t1 of
                         S.Abs f tau1 (S.Abs x tau2 t11) -> S.Abs "kappa" (S.TypeArrow (toCPSType (fromJust $ T.typing capGamma t) answerType) answerType) (S.App (S.Var "kappa") (S.Fix (S.Abs f (toCPSType tau1 answerType) (S.Abs x (toCPSType tau2 answerType) (toCPSWithContext answerType t11 (T.Bind (T.Bind capGamma f tau1) x tau2))))))
    ...
    S.Bop op t1 t2  -> S.Abs "kappa" (S.TypeArrow S.TypeInt answerType) (S.App (toCPSWithContext answerType t1 capGamma) (S.Abs "v1" S.TypeInt (S.App (toCPSWithContext answerType t2 capGamma) (S.Abs "v2" S.TypeInt (S.App (S.Var "kappa") (S.Bop op (S.Var "v1") (S.Var "v2")) )))))
    S.Bpr p t1 t2   -> S.Abs "kappa" (S.TypeArrow S.TypeBool answerType) (S.App (toCPSWithContext answerType t1 capGamma) (S.Abs "v1" S.TypeInt (S.App (toCPSWithContext answerType t2 capGamma) (S.Abs "v2" S.TypeInt (S.App (S.Var "kappa") (S.Bpr p (S.Var "v1") (S.Var "v2")) )))))
    ...
    S.IntEq t1 t2   -> S.Abs "kappa" (S.TypeArrow S.TypeBool answerType) (S.App (toCPSWithContext answerType t1 capGamma) (S.Abs "v1" S.TypeInt (S.App (toCPSWithContext answerType t2 capGamma) (S.Abs "v2" S.TypeInt (S.App (S.Var "kappa") (S.IntEq (S.Var "v1") (S.Var "v2")) )))))
    S.IntLt t1 t2   -> S.Abs "kappa" (S.TypeArrow S.TypeBool answerType) (S.App (toCPSWithContext answerType t1 capGamma) (S.Abs "v1" S.TypeInt (S.App (toCPSWithContext answerType t2 capGamma) (S.Abs "v2" S.TypeInt (S.App (S.Var "kappa") (S.IntLt (S.Var "v1") (S.Var "v2")) )))))
    -}
